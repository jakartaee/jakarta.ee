...
import contributorLists from './versions.js';

const cardList = document.querySelector('.card-list.contributor-list');
const releaseVersion = cardList?.dataset?.version;

if (!!cardList && releaseVersion) {
  // get this page version from data-version attribute
  const contributorList = contributorLists[releaseVersion];
