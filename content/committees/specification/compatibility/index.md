...
Help the Jakarta EE Working Group get your compatible implementation of a specification listed on the specification’s page by creating a PR. In the case of compatible products, implementations of either the Jakarta EE Platform specification and/or the Jakarta EE Web Profile specification will be listed on the Compatible Products page. 
...
Model-View-Controller, or MVC for short, is a common pattern in Web frameworks where it is used predominantly to build HTML applications. The model refers to the applicationâ€™s data, the view to the applicationâ€™s data presentation and the controller to the part of the system responsible for managing input, updating models and producing output.
...
1.  Produced a final staging release via OSSRH staging repository for the api,
    ...
    -   Existing \"\@version ...â€‹\" JavaDoc tags should be updated to
        match, or removed.
